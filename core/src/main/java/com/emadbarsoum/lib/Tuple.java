/* Fork TupleWritable to work around it limitation*/
 ...
 * capable. Tuple relies on the join framework for type safety and
 ...
 */
public class Tuple implements Writable, Iterable<Writable> {
